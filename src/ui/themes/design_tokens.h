...
static const vm_color_scheme_t vm_scheme_high_contrast = {
    ...
    /* Alarm colors (same as dark) */
    .alarm_high             = VM_RED,
    .alarm_medium           = VM_YELLOW_AMBER,
    .alarm_low              = VM_CYAN,
    .alarm_none             = VM_GREEN,

    /* Parameter colors (same as dark) */
    .param_hr               = VM_GREEN,
    .param_spo2             = VM_CYAN,
    .param_nibp             = VM_WHITE,
...
static const vm_color_scheme_t vm_scheme_dimmed = {
    /* Surface hierarchy -- darker overall */
    .background             = 0x050505,
    .surface                = 0x101010,
